//IntArrayBag, modified to satisfy assignment 
//Greg De La Torre
//CS272 - Lab 3
/******************************************************************************
...
public class IntArrayBag implements Cloneable
{
   ...
   **/   
   ...
   //
   //Determines whether or not the two bags are equal to one another
   //Precondition: Both b1 and b2 are not null
   //Return: Boolean true or false if the bag values are true or false
   //
   public boolean equals (Object obj){
	   if (obj instanceof IntArrayBag)    {      
		   IntArrayBag candidate = (IntArrayBag) obj;  
		   return (candidate.data == data) && (candidate.manyItems == manyItems);
		}
			else
				return false;
	}
   ...
   //
   //toString method to print the selected array as "{int, int, int}"
   //Precondition: Bag is not null
   //Return: Array (Bag) printed as "{int, int, int, ...}"
   //
